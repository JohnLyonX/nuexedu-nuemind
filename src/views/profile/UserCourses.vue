...
const fetchCourses = async () => {
  ...
  try {
    // 实际项目中应该从API获取数据
    // const response = await fetch('http://localhost:1024/dev-api/edu/user/courses')
      ...
      courses.value = [
        {
          ...
          name: 'C语言进阶课程',
          teacher: '梁工',
          coverImage: 'https://nuex-edu.oss-cn-guangzhou.aliyuncs.com/couses/bVdaIUN.webp',
          progress: 75,
          status: 'learning',
          lastStudyTime: '2023-05-15 14:30'
        },
        {
          id: 2,
          name: 'Java面向对象编程',
          teacher: '梁工',
          coverImage: 'https://nuex-edu.oss-cn-guangzhou.aliyuncs.com/couses/image-blog-revel-top-java-tools.jpg',
          progress: 30,
          status: 'learning',
          lastStudyTime: '2023-05-14 10:15'
        },
