...
<template>
    ...
    <div class="advantages-container">
      ...
      <section style="margin-top: 8rem;">
        <p class="section-subtitle" style="margin: 0; font-weight: bold; font-size: 1.2rem; color: #2c3e50;; font-family: 'Goodly';">
    ...
    <section class="team-section">
        <div class="team-container">
          ...
          <p class="section-subtitle">汇聚行业精英，引领AI技术创新</p>
          ...
          <div class="team-grid">
            <div class="team-card">
              ...
              <h3>张博士</h3>
              <p class="team-title">首席科学家</p>
              <p class="team-desc">人工智能领域资深专家，拥有15年研究经验，曾在顶级学术期刊发表多篇论文。</p>
            </div>
            ...
            <div class="team-card">
              ...
              <h3>李工</h3>
              <p class="team-title">技术总监</p>
              <p class="team-desc">资深软件架构师，擅长大规模分布式系统设计，曾领导多个千万级项目开发。</p>
            </div>
            ...
            <div class="team-card">
              ...
              <h3>王博士</h3>
              <p class="team-title">数据科学家</p>
              <p class="team-desc">专注于机器学习与数据挖掘，在计算机视觉和自然语言处理领域有深厚积累。</p>
            </div>
          </div>
        </div>
      </section>
...
@media (max-width: 992px) {
  ...
  .case-content {
    flex-direction: column; /* 平板及以下改为列方向 */
  }
